...
public class Empleado {
    ...
    public int AgregarEmpleado(){
        ...
        try {
            ...
            String query="INSERT INTO empleados (nombres, apellidos, direccion, telefono, DPI, genero, fecha_nacimiento, idPuesto, fecha_inicio_laborales, fechaingreso) VALUES (?,?,?,?,?,?,?,?,?,?);";
            Con.abrir_conexion();
